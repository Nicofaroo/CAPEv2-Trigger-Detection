...
def main():
    ...
    guardar(pd.DataFrame(filas), "T1_prevalencia",
            ...
            "Un lift proximo a 1 indica que el indicador NO discrimina. Esta tabla "
            "promedia sobre muestras en las que el instrumento no es aplicable "
    ...
    guardar(pd.DataFrame(filas_b), "T1b_prevalencia_aplicable",
            ...
            f"reglas se pronuncien: {len(ma)} de malware y {len(ga)} de control.")
